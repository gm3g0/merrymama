...
class be_member extends Controller
{
    ...
    public function index()  //會員專區的訂單查看頁面
    {
        ...
        return view('be_member.check', ['account' => $account , 'dataorder' => $dataorder , 'datadetail_order' => $datadetail_order ]);
    }
    ...
    public function create() //會員專區的修改資料頁面
    {
        ...
        return view('be_member.edit' , ['account' => $account ,'datamember' => $datamember]);
    }
