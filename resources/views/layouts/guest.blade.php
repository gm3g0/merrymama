...
<body >
    <div>
          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                  <button id="myb" class="nav-link" onclick="location.href='{{route('singup.index')}}'">註冊</button>
                </li>
                <li class="nav-item">
                  <button id="myb" class="nav-link"onclick="location.href='{{route('login.index')}}'">登入</button>
                </li>
      ...
      <div>
        <i class="fas fa-arrow-down text-center" id=down style="display: none"></i>
        <i class="fas fa-arrow-up text-center" id=top style="display: none"></i>
      </div>
      <footer class="footer">
